...
async function sendAi(sub, body, stream = false, method = "POST") {
    try {
...
async function getIdealModel(preferred) {
...
async function askAiStream(message, onChunk, context = true, doStream = true, model) {
